...
public class EstructuraDenominacionService : MultiOrganizationalBaseService<EstructuraDenominacionDto, EstructuraDenominacion>, IEstructuraDenominacionService
{
    ...
    public async System.Threading.Tasks.Task<ROCA.Emuna360.Domain.Common.Results.Result<System.Collections.Generic.IEnumerable<EstructuraDenominacionDto>>> GetByIglesiaAsync(int iglesiaId, int denominacionId) { var entities = await _specificRepository.GetByIglesiaAsync(iglesiaId, denominacionId); return ROCA.Emuna360.Domain.Common.Results.Result<System.Collections.Generic.IEnumerable<EstructuraDenominacionDto>>.Success(_mapper.Map<IEnumerable<EstructuraDenominacionDto>>(entities)); }
}
