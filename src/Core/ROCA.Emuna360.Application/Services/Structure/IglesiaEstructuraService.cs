...
public class IglesiaEstructuraService : BaseService<IglesiaEstructuraDto, IglesiaEstructura>, IIglesiaEstructuraService
{
    ...
    public async System.Threading.Tasks.Task<System.Collections.Generic.IEnumerable<IglesiaEstructuraDto>> GetByIglesiaAsync(int iglesiaId) { var entities = await _specificRepository.GetByIglesiaAsync(iglesiaId); return _mapper.Map<IEnumerable<IglesiaEstructuraDto>>(entities); }
}