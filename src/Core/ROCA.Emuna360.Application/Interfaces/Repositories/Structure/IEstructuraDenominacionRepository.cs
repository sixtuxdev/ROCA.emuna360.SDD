...
public interface IEstructuraDenominacionRepository : IMultiOrganizationalRepository<EstructuraDenominacion>
{
    Task<IEnumerable<EstructuraDenominacion>> GetByDenominacionAsync(int denominacionId);
    Task<IEnumerable<EstructuraDenominacion>> GetByIglesiaAsync(int iglesiaId, int denominacionId);
}
