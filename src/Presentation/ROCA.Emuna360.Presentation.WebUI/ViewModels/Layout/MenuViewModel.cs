...
namespace ROCA.Emuna360.Presentation.WebUI.ViewModels.Layout;

public sealed class MenuViewModel
{
    private readonly TokenStorageService _tokenStorage;

    public MenuViewModel(TokenStorageService tokenStorage)
    {
    ...
    public async Task InitializeAsync()
    {
        try
        {
            ...
            {
                ExpandedGroups.TryAdd(grupo.MenuId, false);
            }
        }
        finally
        {
