...
public class CorregimientosController : BaseController<CorregimientoDto>
{
    public CorregimientosController(ICorregimientoRepository repository) : base(repository) { }
}
